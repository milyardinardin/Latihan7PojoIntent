    ...
    public void onClick(View view) {
        switch(view.getId()){
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME,"Milyardin Labana Permana");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 16);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mperson = new Person();
                mperson.setName("Milyardin Labana Permana");
                mperson.setAge(16);
                mperson.setEmail("labanamilyardin@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "085157133093";
